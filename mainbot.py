...
while True:
    user = api.get_user('pratinav26')
    api.update_profile(name=f'pyro|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : pyro|{follower_count(user)} Followers')
